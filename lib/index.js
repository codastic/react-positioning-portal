import { Component, createRef, createElement, Fragment, cloneElement, useState } from 'react';
...
class PositioningPortal extends Component {
    constructor() {
        super(...arguments);
        this.state = {
            top: null,
        ...
        this.handleOutsideMouseClick = (event) => {
            ...
            const parentDom = findDOMNode(this);
    ...
    render() {
        ...
        const { top, left, parentRect, portalRect, isPositioned, isOpen, strategy, transitionActive, shouldRender } = this.state;
        ...
        const renderPortal = () => createPortal(cloneElement(portalElement || createElement("div", null), {
            ref: this.portalRef,
...
const PositioningPortalWithState = (props) => {
    ...
    return (createElement(PositioningPortal, Object.assign({}, restProps, { isOpen: isOpen, onShouldClose: close }), renderProps$1(children, {
        open,
        close,
        isOpen
    })));
